import {
  ...
  export class BetterBoard {
    ...
    selectElements() {
      ...
      this.upArrow = document.getElementById("up");
      this.downArrow = document.getElementById("down");
      this.leftArrow = document.getElementById("left");
      this.rightArrow = document.getElementById("right");
      this.crossArrow = document.getElementById("crossArrow");
    }
    ...
    addEventListeners() {
      ...
      this.upArrow.addEventListener("click", this.handleClick.bind(this));
      this.downArrow.addEventListener("click", this.handleClick.bind(this));
      this.leftArrow.addEventListener("click", this.handleClick.bind(this));
      this.rightArrow.addEventListener("click", this.handleClick.bind(this));
      this.crossArrow.addEventListener("click", this.handleClick.bind(this));
    }
